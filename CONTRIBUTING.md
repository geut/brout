...
Fork the project [on GitHub](https://github.com/geut/brout) and check out your copy locally.

```bash
$ git clone git@github.com:username/brout.git
$ cd brout
$ npm install
$ git remote add upstream git://github.com/geut/brout.git
```
