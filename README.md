# brout
Log your browser scripts

[![Build Status](https://travis-ci.com/geut/brout.svg?branch=main)](https://travis-ci.com/geut/brout)
...
:bug: If you found an issue we encourage you to report it on [github](https://github.com/geut/brout/issues). Please specify your OS and the actions to reproduce it.

## Contributing

:busts_in_silhouette: Ideas and contributions to the project are welcome. You must follow this [guideline](https://github.com/geut/brout/blob/main/CONTRIBUTING.md).
